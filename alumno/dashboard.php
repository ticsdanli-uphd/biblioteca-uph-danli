...
<div class="col-12 col-md-6"><a href="/biblioteca/alumno/prestamos.php" class="text-decoration-none"><div class="card border-0 shadow-sm h-100"><div class="card-body"><h4><i class="fas fa-book-reader me-2"></i>Mis préstamos</h4><p class="text-muted mb-0">Consulta fechas de devolución y estado.</p></div></div></a></div>
</div></div>
